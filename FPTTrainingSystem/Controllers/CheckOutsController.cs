...
namespace FPTTrainingSystem.Controllers
{
    public class CheckOutsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Address,EmailAddress,PhoneNumber")] CheckOut checkOut)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Address,EmailAddress,PhoneNumber")] CheckOut checkOut)
        {
            if (ModelState.IsValid)
            {
